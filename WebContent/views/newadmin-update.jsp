	...
	<div id="wrapper">
		<div class="contents">
			...
			<p class="small-letters">
				<span class="margin">update existing products</span>
			</p>
		</div>
		...
		<div class="menu">
			...
			<form action="update" method="post">
				<p class="product-info">
					<b>Product Id</b> <input type="text" name="productId"
						value="${product.productId}" class="admin-form"> <input
				...
				<table class="product-table">
					...
					<tr>
						...
						<td class="admin-form"><input type="text" name="price"
							value="${product.price}"></td>
					</tr>

					<tr>
						<th class="product-info">Image</th>
						<td class="admin-form"><input type="text" name="image"
				...
				<p>
					<input type="submit" value="Update" name="button"
						class="admin-button" onclick="return confirm('商品を変更します.よろしいですか？');"> <input type="submit" value="Back"
